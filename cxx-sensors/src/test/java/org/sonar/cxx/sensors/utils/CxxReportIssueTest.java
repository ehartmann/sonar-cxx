...
public class CxxReportIssueTest {
  ...
  public void reportIssueEquality() {
    List<CxxReportLocation> multipleLocations = new ArrayList<>();
    multipleLocations.add(new CxxReportLocation("path0.cpp", "1", "Null pointer dereference: ptr"));
    multipleLocations.add(new CxxReportLocation("path0.cpp", "1", "Assignment &apos;ptr=nullptr&apos;, assigned value is 0"));

    CxxReportLocation singleLocation = new CxxReportLocation("path2.cpp", "1", "Exception thrown in destructor.");
    List<CxxReportLocation> singleLocationAsList = new LinkedList<>();
    singleLocationAsList.add(singleLocation);

    CxxReportIssue issue0 = new CxxReportIssue("cppcheck", "nullPointer", multipleLocations);
    CxxReportIssue issue1 = new CxxReportIssue("cppcheck", "exceptThrowInDestructor", singleLocation);
    CxxReportIssue issue2 = new CxxReportIssue("cppcheck", "exceptThrowInDestructor", singleLocationAsList);
